...
Available on the **Nano**, **Pro**, and **Agency** tiers.
...
Maintenance mode is available on the **Nano**, **Pro**, and **Agency** tiers. Free-tier users can see the menu option but will be prompted to upgrade when clicking it.
