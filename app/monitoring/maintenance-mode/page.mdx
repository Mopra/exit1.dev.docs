...
Available on the **Nano** and **Pro** tiers.
...
Maintenance mode is available on the **Nano** and **Pro** tiers. Free and Indie users can see the menu option but will be prompted to upgrade when clicking it.
