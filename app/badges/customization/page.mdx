...
By default, badges include a small exit1.dev footer below the badge. Users on any paid plan (Nano, Pro, Agency) can remove this for a clean, white-label look.
