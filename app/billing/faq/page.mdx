...
You cannot create new monitors beyond your plan limit (10 on Free). Existing checks continue to run. Upgrade to the Nano plan for unlimited monitors.
...
MCP is available on the **Nano** plan and above. Free plan users can upgrade to Nano ($5/month) to access it.
